                     ...
                     <div class="col-lg-12 d-flex align-items-stretch">
                         <div class="card w-100">
                             <div class="card-body p-4">
                                 <h5 class="card-title fw-semibold mb-4">Liste de tous les candidats</h5>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="border-bottom-0 d-flex">
                                                     <div class="d-flex align-items-center justify-content-center">
                                                         <img src="http://localhost/iai_project_php/website/controllers/uploads/<?php echo $row['photo_passport'] ?>" alt="Image de Profil"
